...
router.post('/courses/:course_num/assignments/:assignment_num/submissions/create', AuthCheck.isAuthenticated, AuthCheck.isInstructorOrUser, submissionsUpload.any(), SubmissionController.createSubmission);
