...
export class UpdateAssignment extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.redirect) {
      this.context.router.push(
        "/courses/" + nextProps.params.course + "/assignments"
      );
    }

    if (
      this.state.name == "" &&
      nextProps.assignmentsMap[nextProps.params.assignment] != undefined
    ) {
      ...
      this.setState({
        ...
        num_probs: assign.problems.length
      });
    }
  }

  wrapperFunction = location => {
    return (event, date) => {
      this.dateChange(event, date, location);
    };
  };
  ...
  render() {
    ...
    var problemHTML = id_num => {
      return (
        <span key={id_num}>
          <TextField
            id={"problem_name-" + id_num}
            value={this.state.problems[id_num].problem_name}
          ...
          <TextField
            id={"score-" + id_num}
            value={this.state.problems[id_num].score}
            onChange={this.problemChange}
            hintText="Max Score"
            floatingLabelText="Max Score"
          />
          <br />
          <br />
        </span>
    ...
    return (
      <div>
        {this.props.errorObject != "" ? (
          <Alert text={this.props.errorObject} type="error" />
        ) : null}
        <Card initiallyExpanded={true}>
          ...
          <CardText expandable={true}>
            <TextField
              ...
              floatingLabelText="Assignment Display Name"
            />
            <br />
            <DatePicker
              id="startDate"
              value={this.state.startDate}
              onChange={this.wrapperFunction("startDate")}
            ...
            <TimePicker
              ...
              onChange={this.wrapperFunction("startTime")}
            ...
            <DatePicker
              ...
              onChange={this.wrapperFunction("dueDate")}
              style={{ display: "inline-block" }}
            ...
            <TimePicker
              ...
              onChange={this.wrapperFunction("dueTime")}
              className={styles.adjust}
              style={{ display: "inline-block" }}
            ...
            <DatePicker
              ...
              onChange={this.wrapperFunction("endDate")}
              style={{ display: "inline-block" }}
            ...
            <TimePicker
              ...
              onChange={this.wrapperFunction("endTime")}
              className={styles.adjust}
              style={{ display: "inline-block" }}
            ...
            <AutoComplete
              ...
              onUpdateInput={this.otherChange}
              floatingLabelText="Category"
              filter={AutoComplete.noFilter}
              openOnFocus={true}
              dataSource={getCategories(this.props.assignmentsData)}
            />
            <br />
            <br />
            <br />
        ...
        <RaisedButton
          ...
          onClick={() => {
            this.props.submitForm(this.state, this.props.params.course);
          }}
          primary={true}
        />
      </div>
